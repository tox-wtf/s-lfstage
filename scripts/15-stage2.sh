...
./configure --prefix=/usr                     \
            ...
            --enable-no-install-program=arch,kill,uptime,base32,b2sum,basenc,chcon,cksum,csplit,dd,df,dir,dircolors,factor,false,fmt,fold,groups,hostid,join,link,logname,md5sum,nice,nl,nohup,numfmt,paste,pathchk,pinky,pr,ptx,runcon,sha224sum,sha384sum,shred,stty,sync,timeout,true,truncate,tsort,tty,unlink,users,vdir,who,whoami
